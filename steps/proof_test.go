...
func TestProofHandler_EmptyLedger(t *testing.T) {
	_, err := steps.ProofHandler(context.Background(), sdk.TypedStepRequest[*emptypb.Empty, *auditv1.ProofRequest]{
		Config: &emptypb.Empty{},
		Input:  &auditv1.ProofRequest{Ledger: ""},
	})
	if err == nil {
...
func TestProofHandler_DBNotRegistered(t *testing.T) {
	const ledger = "proof-test-unregistered"
